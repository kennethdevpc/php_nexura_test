...
@section('content')
    <div class="container">
        ...
        @endif
        <a href="{{url('role/create')}}" class="btn btn-primary float-end"><i class="fa-solid fa-user-plus"></i> Crear </a>
        <br>
        <br>
                    ...
                    <td class="text-lg-end">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end  " aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item d-flex cursor-pointer" href="{{url('/role/'.$role->id.'/edit')}}">
                                    <i class="fa-solid fa-pencil d-flex align-items mr-10"></i>
                                    <div class="fs-13"> Editar</div>
                                </a>

                                <a class="dropdown-item d-flex cursor-pointer" href="{{url('/role/'.$role->id)}}">
                                    <i class="fa-solid fa-circle-info d-flex align-items mr-10"></i>
                                    <div class="fs-13"> Detalle</div>
                                </a>

                                <form class="dropdown-item d-flex cursor-pointer " action="{{url('/role/'.$role->id)}}" method="post" class="d-inline">
                                    @csrf
                                    {{ method_field('DELETE') }}
